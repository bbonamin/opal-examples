...
if (item == null) item = nil;
  ...
  return ($a = ($b = $scope.get('Document'))['$ready?'], $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $a, $b, TMP_4, $c, TMP_5, giphy_api = nil;

  giphy_api = $scope.get('GiphyApi').$new();
    ($a = ($b = $scope.get('Element').$find("#searchButton")).$on, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this, $a, query = nil;

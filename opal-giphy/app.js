...
/* Generated by Opal 0.7.1 */
Opal.modules["giphy_image"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$attr_reader', '$new', '$[]']);
  return (function($base, $super) {
    function $GiphyImage(){};
    var self = $GiphyImage = $klass($base, $super, 'GiphyImage', $GiphyImage);
    ...
    return (def.$initialize = function(url) {
      ...
      self.html_tag = "<img src='" + (url) + "' class='img-responsive' alt='Responsive image'>";
      return self;
    }, nil) && 'initialize';
  })(self, null)
};
...
/* Generated by Opal 0.7.1 */
Opal.modules["giphy_api"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$gsub', '$get', '$each', '$html_tag', '$from_json', '$append', '$images', '$first', '$shuffle', '$fetch', '$json', '$find']);
  return (function($base, $super) {
    function $GiphyApi(){};
    var self = $GiphyApi = $klass($base, $super, 'GiphyApi', $GiphyApi);

    var def = self.$$proto, $scope = self.$$scope;

    Opal.cdecl($scope, 'API_KEY', "dc6zaTOxFJmzC");
...
if (json == null) json = nil;
    ...
    return (def.$images = function() {
      var self = this;

      return $scope.get('Element').$find("#images");
    }, nil) && 'images';
  })(self, null)
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$ready?', '$new', '$on', '$attr', '$find', '$nil?', '$alert', '$search', '$html']);
  self.$require("opal");
  self.$require("opal-jquery");
  self.$require("pp");
  self.$require("app.rb"+ '/../' + "giphy_image");
  self.$require("app.rb"+ '/../' + "giphy_api");
  return ($a = ($b = $scope.get('Document'))['$ready?'], $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $a, $b, TMP_2, $c, TMP_3, giphy_api = nil;

  giphy_api = $scope.get('GiphyApi').$new();
    ($a = ($b = $scope.get('Element').$find("#searchButton")).$on, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $a, query = nil;

    query = $scope.get('Element').$find("#searchBox").$attr("value");
      if ((($a = query['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return self.$alert("Boo, try again. Write something in the search box")
        } else {
        return giphy_api.$search(query)
      };}, TMP_2.$$s = self, TMP_2), $a).call($b, "click");
    return ($a = ($c = $scope.get('Element').$find("#startOverButton")).$on, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

    return $scope.get('Element').$find("#images").$html("")}, TMP_3.$$s = self, TMP_3), $a).call($c, "click");}, TMP_1.$$s = self, TMP_1), $a).call($b);
})(Opal);

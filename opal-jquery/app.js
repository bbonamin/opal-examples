...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$attr_reader', '$+', '$ready?', '$find', '$new', '$on', '$click!', '$html', '$to_s', '$count']);
  self.$require("opal");
  self.$require("opal-jquery");
  (function($base, $super) {
    function $Clicker(){};
    var self = $Clicker = $klass($base, $super, 'Clicker', $Clicker);
    ...
    return (def['$click!'] = function() {
      var self = this;

      return self.count = self.count['$+'](1);
    }, nil) && 'click!';
  })(self, null);
  return ($a = ($b = $scope.get('Document'))['$ready?'], $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $a, $b, TMP_2, button = nil, clicker = nil, click_count_node = nil;

  button = $scope.get('Element').$find("#clickerButton");
    clicker = $scope.get('Clicker').$new();
    click_count_node = $scope.get('Element').$find("#clickCount");
    return ($a = ($b = button).$on, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

    clicker['$click!']();
      return click_count_node.$html(clicker.$count().$to_s());}, TMP_2.$$s = self, TMP_2), $a).call($b, "click");}, TMP_1.$$s = self, TMP_1), $a).call($b);
})(Opal);
